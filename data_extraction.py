...
def get_data(train, valid, test, batch_size):
    ...
    valid_gen, valid_steps = get_data_generator(X_valid, Y_valid, nrows_valid, batch_size)
...
def data_process_eICU(data_path, time_length):
    batch_size = 256
    ...
    train, valid, test = normalize_data_mort(df_data, train_idx, valid_idx, test_idx)
